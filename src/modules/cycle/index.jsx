...
function ModuleShell({ title }) {
  return (
    <div className="min-h-screen bg-[#F3EAE7] pb-nav px-4 pt-8 max-w-md mx-auto">
      <p className="font-cinzel text-rose tracking-widest text-xs uppercase mb-2">Cycle</p>
