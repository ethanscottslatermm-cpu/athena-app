  ...
  return (
    <div className="space-y-5 pb-4">
      ...
      <div
        ...
        style={{ background: 'rgba(232,130,154,0.1)', border: '1px solid rgba(232,130,154,0.25)' }}
      >
        <div className="flex items-center justify-between mb-3">
          ...
          <button
            ...
            style={{ background: periodOn ? '#E8829A' : 'rgba(59,51,48,0.15)' }}
          >
            <div
            ...
            {FLOW_LABELS.map((label, i) => (
              ...
              >
                <span
                  ...
                  style={{ color: flow >= i + 1 ? '#E8829A' : 'rgba(59,51,48,0.18)' }}
                >
                  {flow >= i + 1 ? '💧' : '○'}
                </span>
                ...
                {cat.items.map(sym => {
                  ...
                  return (
                    <button
                      ...
                      style={{
                        background: on ? 'rgba(232,130,154,0.18)' : 'transparent',
                        border: on ? '1px solid rgba(232,130,154,0.6)' : '1px solid rgba(59,51,48,0.18)',
                        color: on ? '#E8829A' : 'rgba(59,51,48,0.5)',
                      }}
                    >
                      {sym}
                    </button>
          ...
          {MOODS.map(m => (
            ...
            >
              <div
                ...
                style={{
                  border: mood === m.value ? '2px solid #E8829A' : '2px solid rgba(59,51,48,0.1)',
                  background: mood === m.value ? 'rgba(232,130,154,0.12)' : 'rgba(59,51,48,0.05)',
                }}
              >
                <img
                  src={m.icon}
              ...
              {Array.from({ length: 10 }, (_, i) => (
                <button key={i} onClick={() => setWater(i + 1)}>
                  <span
                    ...
                    style={{ color: i < water ? '#E8829A' : 'rgba(59,51,48,0.18)' }}
                  >
                    {i < water ? '💧' : '○'}
                  </span>
                </button>
      ...
      <button
        ...
        style={{
          background: saved ? 'rgba(232,130,154,0.12)' : 'transparent',
