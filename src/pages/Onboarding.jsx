...
const GOLD = 'rgba(255,246,238,0.95)'
const IVORY = 'rgba(255,246,238,0.95)'
const DIM = 'rgba(196, 133, 154, 0.6)'
...
function CornerBrackets() {
  const b = '1px solid rgba(196, 133, 154, 0.2)'
  const size = 18
    ...
    <div style={{ display: 'flex', gap: '7px', justifyContent: 'center', alignItems: 'center' }}>
      {Array.from({ length: total }, (_, i) => (
        <div key={i} style={{
          ...
          height: '6px',
          borderRadius: '3px',
          background: i <= step ? 'rgba(196, 133, 154, 0.9)' : 'rgba(196, 133, 154, 0.2)',
  ...
  return (
    <button
      ...
      style={{
        padding: '8px 14px',
        borderRadius: '100px',
        border: `1px solid ${selected ? 'rgba(196, 133, 154, 0.55)' : 'rgba(196, 133, 154, 0.15)'}`,
        background: selected ? 'rgba(196, 133, 154, 0.08)' : 'rgba(255, 255, 255, 0.03)',
        color: selected ? 'rgba(255,246,238,0.95)' : 'rgba(196, 133, 154, 0.6)',
...
function CardOption({ label, sub, selected, onClick }) {
  return (
    ...
    >
      <p style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '14px', color: selected ? 'rgba(255,246,238,0.95)' : 'rgba(196, 133, 154, 0.6)', margin: 0 }}>
        {label}
      </p>
      {sub && (
        <p style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '12px', color: 'rgba(196, 133, 154, 0.35)', margin: '2px 0 0' }}>
          {sub}
        </p>
      )}
    </button>
  ...
  return (
    <div style={{ marginBottom: '20px' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '4px' }}>
        <span style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '11px', color: 'rgba(196, 133, 154, 0.3)' }}>{min}</span>
        <span style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '11px', color: 'rgba(196, 133, 154, 0.3)' }}>{max}</span>
      </div>
    </div>
  )
}
  ...
  return (
    <>
      <style>{`
        ...
        .ob-scroll input::placeholder { color: rgba(196, 133, 154, 0.45); }
        .ob-scroll input::-webkit-input-placeholder { color: rgba(196, 133, 154, 0.45); }
      `}</style>

      {/* ── Full-screen background ── */}
      <div style={{ position: 'fixed', inset: 0, background: '#0d0a09', overflow: 'hidden' }}>
        <img src="/login-hero.png" alt="" aria-hidden draggable={false} style={{
          position: 'absolute', inset: 0, width: '100%', height: '100%',
          objectFit: 'cover', objectPosition: '22% 8%',
          opacity: 0.72,
          filter: 'contrast(1.08) brightness(1.04) saturate(1.1)',
          userSelect: 'none', pointerEvents: 'none',
        }} />
        {/* Top vignette */}
        <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to bottom, rgba(13,10,9,0.35) 0%, transparent 40%)', pointerEvents: 'none' }} />
        {/* Bottom vignette */}
        <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to top, rgba(13,10,9,0.3) 0%, rgba(13,10,9,0.08) 55%, transparent 100%)', pointerEvents: 'none' }} />
            ...
            <div style={{ width: '100%', display: 'flex', justifyContent: 'flex-end' }}>
              <button
                ...
                style={{
                  ...
                  color: 'rgba(196, 133, 154, 0.4)', background: 'none', border: 'none', cursor: 'pointer',
                }}
              >
                EXIT
              </button>
        ...
        {!affirmation && !showEntrance && (
          ...
          <div
            style={{
              ...
              boxShadow: '0 0 24px rgba(196, 133, 154, 0.06) inset, 0 0 40px rgba(196, 133, 154, 0.04)',
          ...
          >
            ...
            <div style={{
              ...
              height: '1px', borderRadius: '28px 28px 0 0',
              background: 'linear-gradient(90deg, transparent, rgba(196, 133, 154, 0.3), transparent)',
              pointerEvents: 'none',
            }} />

            {/* Step header */}
            <div style={{ padding: '22px 22px 0', flexShrink: 0 }}>
              <p style={{ fontFamily: 'Cinzel, serif', fontSize: '9px', letterSpacing: '0.28em', color: 'rgba(196, 133, 154, 0.45)', textTransform: 'uppercase', marginBottom: '4px' }}>
                Step {step + 1} of 5
              </p>
              <h2 style={{ fontFamily: 'Cinzel, serif', fontSize: '18px', color: 'rgba(255,246,238,0.95)', letterSpacing: '0.06em', margin: 0 }}>
                {stepTitle}
              </h2>
            </div>
                  ...
                  <div style={{ marginBottom: '20px' }}>
                    ...
                    <input
                      ...
                      style={{
                        ...
                        border: 'none', borderBottom: '1px solid rgba(196, 133, 154, 0.25)',
                        borderTop: 'none', borderLeft: 'none', borderRight: 'none',
                        padding: '8px 0', color: 'rgba(255,246,238,0.95)',
                        fontFamily: 'Cormorant Garamond, serif', fontSize: '15px',
                        outline: 'none', caretColor: 'rgba(255,246,238,0.95)',
                      }}
                    />
                  </div>
                    ...
                    {!periodUnknown ? (
                      <>
                        ...
                        <button
                          ...
                          style={{ fontFamily: 'Cormorant Garamond, serif', fontStyle: 'italic', fontSize: '12px', color: 'rgba(196, 133, 154, 0.4)', background: 'none', border: 'none', cursor: 'pointer', marginTop: '8px', padding: 0 }}
                        >
                      ...
                      <>
                        ...
                        <button
                          ...
                          style={{ fontFamily: 'Cormorant Garamond, serif', fontStyle: 'italic', fontSize: '12px', color: 'rgba(196, 133, 154, 0.4)', background: 'none', border: 'none', cursor: 'pointer', marginTop: '4px', padding: 0 }}
                        >
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '12px' }}>
                      ...
                      <button
                        ...
                        style={{
                          ...
                          background: answers.notifications_on ? 'rgba(196, 133, 154, 0.5)' : 'rgba(196, 133, 154, 0.1)',
                      ...
                      <div>
                        ...
                        <input
                          ...
                          style={{
                            ...
                            color: 'rgba(255,246,238,0.95)', fontFamily: 'Cinzel, serif', fontSize: '16px',
                            outline: 'none', colorScheme: 'dark',
                          }}
                        />
                      </div>
                      ...
                      {THEMES.map(t => (
                        <button
                          ...
                          style={{
                            ...
                            border: `1px solid ${answers.theme === t.key ? GOLD : 'rgba(196, 133, 154, 0.15)'}`,
                        ...
                        >
                          ...
                          <div style={{ padding: '6px 4px', background: 'rgba(10, 8, 6, 0.55)' }}>
            ...
            <div style={{
              ...
              flexShrink: 0,
              borderTop: '1px solid rgba(196, 133, 154, 0.1)',
            }}>
              {/* Save error */}
              {saveError && (
                <p style={{
